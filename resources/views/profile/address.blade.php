            ...
            <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                <div>
                    ...
                    <input type="text" id="province" name="province" 
                        ...
                        class="mt-1 block w-full rounded-lg bg-gray-700 border border-gray-600 text-gray-100 focus:ring-2 focus:ring-indigo-400 focus:border-indigo-400">
                </div>
