    ...
    <form method="POST" action="{{ route('credit.update') }}" class="space-y-4">
      ...
      <div>
        ...
        <input
          ...
          class="w-full mt-1 p-2 bg-gray-700 border border-gray-600 rounded-lg text-gray-100 focus:ring focus:ring-indigo-500/30"
        >
      </div>
      ...
      <div>
        ...
        <div class="flex gap-2">
          ...
          <div class="w-1/2">
            <select
              name="expiry_month"
              class="w-full p-2 bg-gray-700 border border-gray-600 rounded-lg text-gray-100 focus:ring focus:ring-indigo-500/30"
            >
      ...
      <div class="flex justify-end pt-4">
        <button
          type="submit"
          class="flex items-center gap-2 px-6 py-2.5 bg-indigo-600 hover:bg-indigo-500 text-white rounded-lg font-medium transition-all"
        >
          💾 Save
        </button>
      </div>
